...
const CooperativeLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg">
        <div className="flex h-16 flex items-center justify-between px-6 bg-green-600">
          <div className="flex items-center">
            <Building className="h-8 w-8 text-white" />
            <span className="ml-3 text-xl font-bold text-white">Cooperative Admin</span>
          </div>
          <button
        ...
        {currentCooperative && (
          <div className="px-4 py-3 bg-green-50 border-b border-green-200">
            <div className="text-sm font-medium text-green-800">{currentCooperative.name}</div>
            <div className="text-xs text-green-600">{currentCooperative.status}</div>
          </div>
        )}
        ...
        <nav className="mt-6">
          ...
          <div className="px-3">
            <Link
              to="/cooperative/farmers/register"
              className="flex items-center px-3 py-2 text-sm font-medium text-slate-700 rounded-lg hover:bg-slate-100"
            >
              <Users className="h-5 w-5 mr-3" />
              Register Farmers
      ...
      <div className="pl-64">
        <main className="p-6">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-slate-900">Cooperative Management</h1>
